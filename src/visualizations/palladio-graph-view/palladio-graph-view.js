angular.module('palladioGraphView', [])
	.constant('version', '0.9')
	// Palladio Timechart View
	.directive('palladioGraphView', function () {
	...
	.directive('palladioGraphViewWithSettings', function () {
		...
		return {
			...
			link : {
				...
				pre: function (scope, element, attrs) {
					...
					scope.$emit('registerStateFunctions', ['graphView', exportState, importState]);
