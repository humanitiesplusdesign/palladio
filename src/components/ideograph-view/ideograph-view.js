...
angular.module('palladioIdeographView', ['palladio', 'palladio.services'])
	.directive('palladioIdeographView', function (palladioService, dataService) {
		var directiveObj = {
			scope: true,
			templateUrl: 'partials/ideograph-view/template.html',
